...
const HomeFunding: React.FC = () => {
  return (
    ...
    <section  className=" relative py-6 lg:py-24 2xl:max-w-7xl max-w-6xl m-auto text-white px-4 md:px-0 lg:px-8 flex sm:gap-0 gap-8 flex-col-reverse md:flex-row md:items-center lg:items-end">
