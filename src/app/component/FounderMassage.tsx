  ...
  return (
    <div>
      ...
      >
        ...
        <div className="2xl:max-w-7xl pb-8  max-w-6xl m-auto relativ  flex flex-col lg:flex-row gap-6 pt-16 items-start  text-white   px-4">
          {/* <div
          ...
          >
            ...
            <h3 className="lg:ml-6   text-white font-black helvetic-Head-font text-center text-3xl lg:text-4xl w-full lg:hidden">Founder's Message</h3>
          <Image
            src={md.src}
            alt="Sridhar Vembu"
            width={300}
            height={500}
            className="z-40  object-cover self-center lg:self-auto  md:w-64 lg:w-96 rounded-2xl shadow-xl lg:h-[30rem] "
            data-aos="fade-up"
            data-aos-anchor-placement="top-bottom"
            data-aos-duration="800"
            data-aos-delay="500"
          ...
          <div
            ...
            data-aos-delay="700"
          >
              <h3 className="lg:ml-6  hidden lg:block text-white font-black helvetic-Head-font text-start text-3xl lg:text-4xl pb-6">Founder's Message</h3>
            <p className=" font-normal text-gray-300 lg:ml-6  text-center lg:text-start ">
